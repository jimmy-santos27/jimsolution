    ...
    <div class="col-lg-12">
        <div class="panel panel-default" id="addPanel">
            ...
            <div id ="printContent" class="panel-body" style="font-weight: normal">
                ...
                $singleSR = $TranHead->single_tran($ID);
                $cur = $TranDetl->listofTranPerID($ID);

                $ReceiptHeader = array(
                array("label"=>"Customer Name:", "name"=> $singleSR->CUSTNAME,"nw"=>"50%",
                    "label2"=>"Date:", "name2"=> $singleSR->ENTDATE,"nw2"=>"25%",
                    "label3"=>"Adj. No.:",  "name3"=> $singleSR->ADJNO,"nw3"=>"25%"),
                array("label"=>"Approved By:", "name"=> $singleSR->APPROVEDBY,"nw"=>"50%",
                    "label2"=>" ", "name2"=> "","nw2"=>"25%",
                    "label3"=>"Reference:",  "name3"=> $singleSR->REFNO,"nw3"=>"25%"));

                $tableHeader =  array(
                    array("label"=>"Qty.", "w"=>"5%","fldname"=>"QTY","TYPE"=>'I'),
                    array("label"=>"Qty Reset", "w"=>"5%","fldname"=>"QTYRESET","TYPE"=>'I'),
