...
foreach ($cur as $result){
    ...
    switch ($result->dtFunction) {
        case "CounterReceipt" :
            ...
            $presetFilter = trim($result->where_filter);
        ...
        case "ProductBrochure" :
          ...
          //
           ...
           $pbctr =0;
           foreach ($data as $result2) {
               //echo web_root.$result2->IMAGES;
               if (file_exists("../".$result2->IMAGES)){
                   if ($pbctr>=15){
                   ...
                   echo '<div style="height:210px;margin:5px; border: 2px solid #c0c0c0;">';
        ...
        default :
            ...
            $pgTitle .= "<br><span class='pgTitle'>" . $result->menuname . "</span>";
            echo '<div class="col-lg-12 dtTableWrapper" style=" padding-top:0px; background-color:#fff"><table id="dash-table" class = "table table-borderless">';
            echo '<thead>';
            ...
            //echo $qString . $presetFilter .$result->sorting;
         //   $presetFilter = addslashes($presetFilter);
         //   $dataQuery = addslashes($dataQuery);
           //echo $dataQuery;
            break;
    }
    ...
    $(document).ready(function() {
        ...
        try{
            ...
            if (dtFunc != "ProductBrochure" ) {
                ...
                var queryString = "<?php echo $qString;?>";
