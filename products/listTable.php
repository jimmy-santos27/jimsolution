...
$query = "SELECT CONCAT('DT_',PROID) as ID,   PRONAME, PROCODE, CATEGORIES, format(PROPRICE,2) as PROPRICE, format(WPROPRICE,2) AS WPROPRICE, format(PPROPRICE,2) AS PPROPRICE, PROQTY, LOCATION,";
